...
export function viewFactory_ErrorComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ErrorComponent === null)) {
        (renderType_ErrorComponent = viewUtils.createRenderComponentType('C:/github/modata/assets/app/errors/error.component.html', 0, import9.ViewEncapsulation.Emulated, styles_ErrorComponent, {}));
    }
