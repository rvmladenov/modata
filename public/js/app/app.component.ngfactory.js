...
export var AppComponentNgFactory = new import10.ComponentFactory('my-app', viewFactory_AppComponent_Host0, import3.AppComponent);
...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_2 = import15.viewFactory_HeaderComponent0(this.viewUtils, this.injector(2), this._appEl_2);
        ...
        this._el_10 = this.renderer.createElement(parentRenderNode, 'app-error', null);
        this._appEl_10 = new import2.AppElement(10, null, this, this._el_10);
        var compView_10 = import18.viewFactory_ErrorComponent0(this.viewUtils, this.injector(10), this._appEl_10);
        ...
        compView_10.create(this._ErrorComponent_10_4, [], null);
        this.init([], [
            this._el_0,
            this._text_1,
            this._el_2,
    ...
    _View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import14.ErrorComponent) && (10 === requestNodeIndex))) {
            return this._ErrorComponent_10_4;
        }
        return notFoundResult;
    };
    _View_AppComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._ErrorComponent_10_4.ngOnInit();
        }
...
export function viewFactory_AppComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AppComponent === null)) {
        (renderType_AppComponent = viewUtils.createRenderComponentType('C:/github/modata/assets/app/app.component.html', 0, import9.ViewEncapsulation.Emulated, styles_AppComponent, {}));
    }
