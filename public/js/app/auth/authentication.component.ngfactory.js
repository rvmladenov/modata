...
export function viewFactory_AuthenticationComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AuthenticationComponent === null)) {
        (renderType_AuthenticationComponent = viewUtils.createRenderComponentType('C:/github/modata/assets/app/auth/authentication.component.ts class AuthenticationComponent - inline template', 0, import9.ViewEncapsulation.None, styles_AuthenticationComponent, {}));
    }
