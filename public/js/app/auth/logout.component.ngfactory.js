...
export function viewFactory_LogoutComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_LogoutComponent === null)) {
        (renderType_LogoutComponent = viewUtils.createRenderComponentType('C:/github/modata/assets/app/auth/logout.component.ts class LogoutComponent - inline template', 0, import10.ViewEncapsulation.None, styles_LogoutComponent, {}));
    }
