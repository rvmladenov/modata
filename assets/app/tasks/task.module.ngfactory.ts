...
class TaskModuleInjector extends import0.NgModuleInjector<import1.TaskModule> {
  ...
  get _TaskService_6():import7.TaskService {
    if ((this.__TaskService_6 == (null as any))) { (this.__TaskService_6 = new import7.TaskService(this.parent.get(import10.Http),this.parent.get(import11.ErrorService))); }
    return this.__TaskService_6;
  }
  createInternal():import1.TaskModule {
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.TaskModule)) { return this._TaskModule_3; }
    ...
    if ((token === import7.TaskService)) { return this._TaskService_6; }
    return notFoundResult;
  }
  destroyInternal():void {
  }
}
export const TaskModuleNgFactory:import0.NgModuleFactory<import1.TaskModule> = new import0.NgModuleFactory(TaskModuleInjector,import1.TaskModule);